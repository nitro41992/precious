...
- Field rationale copy must come from structured Capture Analysis output, not client-side string rewriting. Purpose rationale should use `I chose [Purpose] because ...`, Collection rationale should use `I picked [Collection] because ...`, and Later rationale should use `I suggested [Later] because ...`, with each field rationale capped at 12 words and each structured field header capped at 36 characters.
